...
public class CollectableAnimationData : ScriptableObject
{
    ...
    public class SendingData
    {
        ...
        {
            [field: SerializeField] public float Time { get; private set; } = 0.07f;
            [field: SerializeField] public float ScaleFactor { get; private set; } = 0.2f;
        ...
        {
            [field: SerializeField] public float Time { get; private set; } = 0.1f;
            [field: SerializeField] public float ScaleFactor { get; private set; } = 1.2f;
        ...
        public class RandomRangeDelay
        {
            ...
            [field: SerializeField] public float Max { get; private set; } = 0.2f;
        }
        ...
        public class FinalStageData
        {
            ...
            [field: SerializeField] public float PunchScaleFactor { get; private set; } = 1f;
