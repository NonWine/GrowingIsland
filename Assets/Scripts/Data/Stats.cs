...
public class Stats
{
    ...
    [field: ProgressBar(0, 10), SerializeField] [LabelWidth(LabelWidht)] public int MoveSpeed {get; private set; }
    [field: ProgressBar(0, 100), SerializeField] [LabelWidth(LabelWidht)] public int RotateSpeed {get; private set; }
    [field: ProgressBar(0, 10), SerializeField] [LabelWidth(LabelWidht)] public float RadiusDetection {get; private set; }
